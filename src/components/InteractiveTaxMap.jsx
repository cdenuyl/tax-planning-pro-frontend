      ...
      <div className="flex-1 min-h-0">
        ...
        totalMarginalPositions.forEach(({ position, label, magiThreshold }) => {
          allThresholds.push({
            ...
            <ReferenceLine 
              x={methodology === 'incremental' ? totalIncome - (incomeSources && Array.isArray(incomeSources) ? incomeSources.filter(s => s && s.type === 'social-security' && s.enabled).reduce((sum, s) => sum + getYearlyAmount(s), 0) : 0) : totalIncome} 
              stroke="#16a34a" 
              strokeWidth={3}
